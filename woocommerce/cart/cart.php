...
<div class="shop_table_container row-flex">
	<div class="shop_table_form col-xs-12 col-sm-7">
	...
	<div class="cart-collaterals-col col-xs-12 col-sm-5">
		<div class="cart-collaterals-col-inner">

			<div class="coupon_row">
				<div class="coupon_inner_col">

					<?php if ( wc_coupons_enabled() ) { ?>
						<div class="coupon row-flex middle-xs">
							<label for="coupon_code" class="col-xs-2"><?php esc_html_e( 'Coupon:', 'woocommerce' ); ?></label> 
							<input type="text" name="coupon_code" class="input-text col-xs" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" /> 
							<button type="submit" class="button col-xs" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?></button>
