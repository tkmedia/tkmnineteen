					...
					<div class="masthead_content wrap row-flex bottom-xs between-xs">
						<div class="masthead_content_container col-xs-12 col-md">
							<div class="masthead_content_container_wrap">
								<h1 class="entry-title masthead_content_title" itemprop="headline"><?php _e('404: Page not Found', 'tkmnineteen'); ?></h1>
							</div>	
						</div>
		            ...
		            <div class="content row-flex middle-xs">
		                ...
		                <div class="txt-box col-xs-12">
		                    <div class="inner-wrap">
			                    ...
			                    <div><?php _e('The page you are looking for does not exist. Return to', 'tkmnineteen'); ?> <a style="text-decoration: underline;" href="<?php echo esc_url(home_url('/')); ?>"><?php _e('Home Page', 'tkmnineteen'); ?></a></div>
		                        <div class="wide-btn">
		                            <a href="<?php echo esc_url(home_url('/')); ?>" class="black-link"><?php _e('Back to Home Page', 'tkmnineteen'); ?></a>
		                        </div>
		                    </div>
		                </div>
