<?php 
$cat_box_grid_block_width = get_sub_field('cat_box_block_width');
$cat_box_grid_order = get_sub_field('cat_box_order');
$cat_box_grid_mobile = get_sub_field('cat_box_mobile');
$cat_box_grid_hide_mobile = get_sub_field('cat_box_hide_mobile');
$cat_box_grid_break = get_sub_field('cat_box_break');
$cat_box_grid_block_align = get_sub_field('cat_box_block_align');

$cat_box_grid = get_sub_field('cat_box');
$cat_box_grid_count = get_sub_field('cat_box_count');
$cat_box_grid_animation = get_sub_field('cat_box_animation');
		...
		<div class="cat_box_grid flexible_page_element" itemprop="text">
			<div class="cat_box_grid_wrap">
				...
				<?php setup_postdata($post); ?>                     
				    ...
				    <div class="cat_box_grid_item col-xs-<?php $ag_xs_cols; ?> col-sm-<?php $ag_sm_cols; ?> col-md-<?php $ag_md_cols; ?>">
