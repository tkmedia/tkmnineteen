<?php 
$img_content_width = get_sub_field('imc_bw');
$img_content_order = get_sub_field('imc_or');
$img_content_mobile = get_sub_field('imc_mo');
$img_content_hide_mobile = get_sub_field('imc_hmo');
$img_content_break = get_sub_field('imc_br');
$img_content_block_align = get_sub_field('imc_ba');
$img_content_animation = get_sub_field('imc_an');

$img_content_style = get_sub_field('imc_sy');
$img_content_type = get_sub_field('imc_tp');
$img_content_title = get_sub_field('imc_t');
$img_content_subtitle = get_sub_field('imc_st');
$img_content_title_h = get_sub_field('imc_th');
$img_content_title_s = get_sub_field('imc_ts');
$img_content_title_color = get_sub_field('imc_tc');
$img_content_subtitle_color = get_sub_field('imc_stc');
$img_content_text_color = get_sub_field('imc_txc');

$img_content_img = get_sub_field('imc_im');
$img_content_img_size = get_sub_field('imc_ims');
$img_content_text_f = get_sub_field('imc_txf');
$img_content_align = get_sub_field('imc_ia');
$img_content_btn = get_sub_field('imc_bt');
$img_content_link = get_sub_field('imc_lk');
$img_content_btn2 = get_sub_field('imc_bt2');
$img_content_link2 = get_sub_field('imc_lk2');

$img_content_btn_color = get_sub_field('imc_btc');	
$img_content_img_layout = get_sub_field('imc_ly');
$img_content_img_bg = get_sub_field('imc_ibg');	
$img_content_img_side = get_sub_field('imc_isi');	
$img_col_layout = get_sub_field('imc_ily');
$img_content_logo = get_sub_field('imc_lo');
