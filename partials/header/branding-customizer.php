<div class="branding clearfix">
	...
	<div class="header-logo desktop_logo">
	<?php
	// Displaying the custom logo with custom markup
	$custom_logo_id = get_theme_mod( 'custom_logo' );
	$logo = wp_get_attachment_image( $custom_logo_id , 'full' );
	if ( has_custom_logo() ) { ?>
		<a href="<?php echo esc_url(home_url('/')); ?>" title="<?php _e('Logo', 'tkmnineteen'); ?> <?php bloginfo( 'name' ); ?>" rel="home">
	    <?php echo $logo; ?>
	    </a>
	<?php } else { ?>
	...
	<?php if ( get_theme_mod( 'tkmnineteen_mobile_logo' ) ) : ?>
	    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" id="site-logo" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
	        <img src="<?php echo get_theme_mod( 'tkmnineteen_mobile_logo' ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>">
	    </a>
	    <?php else : ?>
	    <hgroup>
