...
$title_ver = get_post_meta( get_the_ID(), 'masthead_title_ver', true );
$slider_overlay = get_field('page_top_slider_overlay');

$btn_type = get_post_meta( get_the_ID(), 'masthead_btn_type', true );
$btn_style = get_post_meta( get_the_ID(), 'masthead_button_style', true );
$btn1_text = get_post_meta( get_the_ID(), 'masthead_btn1_text', true );
$btn1_link = get_post_meta( get_the_ID(), 'masthead_btn1_link', true );
$btn2_text = get_post_meta( get_the_ID(), 'masthead_btn2_text', true );
$btn2_link = get_post_meta( get_the_ID(), 'masthead_btn2_link', true );
$btn1_img = get_field('masthead_btn1_img');
$btn2_img = get_field('masthead_btn2_img');
...
<style>
	...
	#home_masthead .entry-title.masthead_content_title {font-size:<?php echo $home_masthead_content_title; ?>px;}
	...
	<!-- Top Slider -->
		...
		<?php if( $page_top_slider_content == 'youtube_vid' ) { ?>
			...
			<div id="top-slider" class="top-video-container-wrap">
				...
				<?php if ( $page_masthead_subtitle || !$masthead_title_hide || $page_masthead_text || $btn1_text || $btn2_text) { ?>
				<div class="masthead_content wrap row-flex <?php echo($title_hor); ?>-xs <?php echo($title_ver); ?>-xs <?php echo($title_location); ?>"<?php if ($title_location == 'slider_content_bottom' ) { ?> style="background:<?php echo($intro_bg_color); ?>;"<?php } ?>>
					<div class="wrap"><div class="masthead_content_container col-xs-12">
						...
						if ($title_location == 'slider_content_bottom' ) {
							$title_color = get_post_meta( get_the_ID(), 'masthead_title_color', true );
							$text_color = get_post_meta( get_the_ID(), 'masthead_text_color', true );
							$btn_color = get_post_meta( get_the_ID(), 'masthead_btn_color', true );
							$btn_bg_color = get_post_meta( get_the_ID(), 'masthead_btn_bg_color', true );
							$page_masthead_title = esc_html(get_post_meta( get_the_ID(), 'masthead_title', true ));
							$page_masthead_subtitle = esc_html(get_post_meta( get_the_ID(), 'masthead_subtitle', true ));
							$page_masthead_text = wpautop(get_post_meta( get_the_ID(), 'masthead_text', true ));
							$masthead_title_hide = get_post_meta( get_the_ID(), 'masthead_title_hide', true );
