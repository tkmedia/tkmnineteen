...
$product_block_width = get_field('prb_bW');
$product_order = get_field('prb_or');
$product_mobile = get_field('prb_mo');
$product_hide_mobile = get_field('prb_hMo');
$product_break = get_field('prb_br');
$product_block_align = get_field('prb_bAl');

$product = get_field('prb');
$product_animation = get_field('prb_an');

if ( $product_hide_mobile && wp_is_mobile() ) {
//HIDE ON MOBILE
} else { ?>

<div class="flex_content_cols <?php echo $uid; ?> <?php echo $product_mobile;?> <?php echo $product_block_width;?> <?php if( $product_break ){ ?><?php echo $product_block_align; ?><?php } ?>" <?php if( $product_order ){ ?>style="order:<?php echo $product_order; ?>;"<?php } ?>>
	<section id="section-<?php echo $uid; ?>" class="page_flexible page_flexible_content section-<?php echo $uid; ?>" data-aos="<?php echo $product_animation;?>">
