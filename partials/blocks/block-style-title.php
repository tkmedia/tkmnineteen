...
$style_title_block_width = get_field('st_bW');
...
$title_border_color = get_field('st_boC');
...
<div class="flex_content_cols <?php echo $uid; ?> <?php echo $flex_style_title_mobile;?> <?php echo $style_title_block_width;?> <?php if( $title_break ){ ?><?php echo $title_block_align; ?><?php } ?>" <?php if( $title_order ){ ?>style="order:<?php echo $title_order; ?>;"<?php } ?>>
	<section id="section-<?php echo $uid; ?>" class="page_flexible page_flexible_content section-<?php echo $uid; ?> count_sections_<?php echo $uid; ?>" data-aos="<?php echo $style_title_animation;?>">
