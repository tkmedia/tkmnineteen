...
$f_img_block_width = get_field('fi_bw');
$f_img_break = get_field('fi_br');
$f_img_block_align = get_field('fi_bal');
$f_img_order = get_field('fi_or');
$f_img_mobile_cols = get_field('fi_mo');
$f_img_hide_mobile = get_field('fi_hmo');
$image_animation = get_field('fi_an');
$f_img_title = get_field('fi_t');
$f_img_title_size = get_field('fi_tsz');
$f_img_title_color = get_field('fi_tcl');
$f_img_title_align = get_field('fi_tal');
$f_img_title_location = get_field('fi_tlo');
$f_img = get_field('f_img');

$f_img_type = get_field('fi_tp');
$f_img_align = get_field('fi_al');
$f_img_style = get_field('fi_st');
$f_img_bg = get_field('fi_bg');
$f_img_logo = get_field('fi_lg');
$logo_position = get_field('fi_lgP');
$f_img_height = get_field('fi_h'); 
$f_img_text = get_field('fi_tx');
$f_img_text_ver = get_field('fi_txv');
$f_img_text_align = get_field('fi_txal');
$f_img_text_size = get_field('fi_txsz');
$f_img_text_color = get_field('fi_txcl');
$f_img_links = get_field('fi_lk');

$f_img_btn1 = get_field('fi_bt1');
$f_img_btn1_link = get_field('fi_bt1l');
$f_img_btn2 = get_field('fi_bt2');
$f_img_btn2_link = get_field('fi_bt2l');
$f_img_full_link = get_field('fi_fl');
$image_full_link_fancybox = get_field('fi_lfb');

$image_full_top_margin = get_field('fi_ftm');
$image_full_bottom_margin = get_field('fi_bm');

if ( $f_img_hide_mobile && wp_is_mobile() ) {
//HIDE ON MOBILE
} else { ?>

<div class="flex_content_cols <?php echo $uid; ?> <?php echo $f_img_mobile_cols;?> <?php echo $f_img_block_width;?> <?php if( $f_img_break ){ ?><?php echo $f_img_block_align; ?><?php } ?>" <?php if( $f_img_order ){ ?>style="order:<?php echo $f_img_order; ?>;"<?php } ?>>
	<section id="section-<?php echo $uid; ?>" class="page_flexible page_flexible_content section-<?php echo $uid; ?>" data-aos="<?php echo $image_animation;?>">
