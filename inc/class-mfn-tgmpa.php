...
if( ! class_exists( 'TGM_Plugin_Activation' ) ){
	...
	add_action( 'tgmpa_register', 'tkmnineteen_register_required_plugins' );

	/**
	 * Plugin installation and activation for WordPress themes.
	 */
	function tkmnineteen_register_required_plugins() {
		$plugins = array(
			array(
		 ...
		 */
		$config = array(
			'id'           => 'tkmnineteen',                 // Unique ID for hashing notices for multiple instances of TGMPA.
			...
			'strings'      => array(
				'page_title'                      => __( 'התקן רכיבים נדרשים', 'tkmnineteen' ),
				'menu_title'                      => __( 'התקן רכיבים', 'tkmnineteen' ),
				'installing'                      => __( 'מתקין רכיב: %s', 'tkmnineteen' ),
				'updating'                        => __( 'מעדכן רכיב: %s', 'tkmnineteen' ),
				'oops'                            => __( 'משהו השתבש עם ממשק תכנות היישומים של הרכיב', 'tkmnineteen' ),
				...
				'return'                          => __( 'חזור למתקין הרכיבים הנדרשים', 'tkmnineteen' ),
				'plugin_activated'                => __( 'רכיב הופעל בהצלחה.', 'tkmnineteen' ),
				'activated_successfully'          => __( 'הרכיבים הבאים הופעלו בהצלחה:', 'tkmnineteen' ),
				'plugin_already_active'           => __( 'לא בוצעה פעולה. הרכיב %1$s הותקן בעבר.', 'tkmnineteen' ),
				'plugin_needs_higher_version'     => __( 'הרכיב לא הופעל. גירסא עדכנית יותר של %s נדרשת עבור ערכת עיצוב זו. נא לעדכן רכיב.', 'tkmnineteen' ),
				'complete'                        => __( 'כל הרכיבים הותקנו והופעלו בהצלחה. %1$s', 'tkmnineteen' ),
				'dismiss'                         => __( 'מחק הודעה זו', 'tkmnineteen' ),
				'notice_cannot_install_activate'  => __( 'ישנו רכיב אחד או יותר הנדרש או מומלץ להתקנה, הפעלה או עדכון.', 'tkmnineteen' ),
				'contact_admin'                   => __( 'נא ליצור קשר עם מנהל האתר לעזרה.', 'tkmnineteen' ),
				/* 
