	...
	$(window).scroll(function(){
		...
		function ss_get_top_bar_height(){
		    ...
		    if ($(window).scrollTop() >= 1) {
		        ...
		        $('.archive.category.body-fixed-header #page-title').css('padding-top', SSheader_height);
		        ...
		        $('.archive.category #page-title').css('padding-top', '0');
	...
	$(window).scroll(function(){
		...
		function sftb_get_top_bar_height(){
		    ...
		    if ($(window).scrollTop() >= SFTBtop_bar) {
		        ...
		        $('.archive.category.body-fixed-header #page-title').css('padding-top', SFTBheader_height);
