	...
	<div class="page-container">	
		<div class="entry-content" itemprop="text">
			...
			<div class="masthead_clean_intro">
				<?php echo '<div class="home_masthead_text wrap archive-description">' . apply_filters( 'tkmnineteen_the_content', $description ) . '</div>'; ?>
			</div>
			<?php } ?>
			<?php 
			// Build the page
			...
			<div class="magazine_page_index wrap magazin_<?php $archive_article_style; ?> page_link_grid_wrap grid_<?php echo $archive_article_style;?>">
				<div class="magazine_page_grid row-flex articles_grid_item_row center-xs">
				    ...
				    <?php if ( have_posts() ) : $article = 1;?>
				        ...
				        <?php while ( have_posts() ) : the_post(); ?>
							...
							<div class="magazine_page_grid_item col-xs-<?php $cg_xs_cols; ?> col-sm-<?php $cg_sm_cols; ?> col-md-<?php $cg_md_cols; ?>">
								<div class="magazine_page_item_container article_<?php $article; ?>">
													...
													<div class="articles_grid_item_row row-flex">
														...
														<div class="articles_grid_item_content col-xs-12 col-sm-6 col-md-8 col-lg-9">
															<div class="articles_grid_item_inside">
																...
																<?php 
																$excerpt = get_field('masthead_excerpt');
																if( $excerpt ) { ?>
																...
																<div class="articles_grid_item_readon"><?php _e('Read More', 'tkmnineteen'); ?></div>
														...
														jQuery(function($) {
															$(window).load(function(){
															    ...
															    function get_text_height(){
															        //var footer_height = $('#footer_container').height();
															        var text_height = $('.article_<?php $article; ?> .page_links_item_intro').outerHeight();
															        $('.article_<?php $article; ?> .page_links_item_intro').css('margin-bottom', -text_height);
															    }
														    });	
														}); 
														</script>										
